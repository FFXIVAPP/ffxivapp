...
{
    public sealed class AsyncNameToAvatarConverter : IMultiValueConverter
    {
        private const String LodestoneUrl = "http://lodestone.finalfantasyxiv.com/rc/search/search?tgt=77&q=\"{0}\"&cms=&cw={1}";
        private const String DefaultAvatar = "pack://application:,,,/ParseModXIV;component/NoImage.jpg";
        ...
        /// 
        /// </summary>
        public AsyncNameToAvatarConverter()
        {
