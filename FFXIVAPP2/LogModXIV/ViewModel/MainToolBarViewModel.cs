...
namespace LogModXIV.ViewModel
{
    internal class MainToolBarViewModel : INotifyPropertyChanged
    {
        ...
        private static void Minimal()
        {
            ...
            //MainStatusView.View.LayoutRoot.Visibility = System.Windows.Visibility.Collapsed;
        ...
        private static void Full()
        {
            ...
            //MainStatusView.View.LayoutRoot.Visibility = System.Windows.Visibility.Visible;
            try
            {
