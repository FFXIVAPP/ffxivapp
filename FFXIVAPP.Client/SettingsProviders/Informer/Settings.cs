...
namespace FFXIVAPP.Client.SettingsProviders.Informer
{
    public class Settings : ApplicationSettingsBase, INotifyPropertyChanged
    {
        ...
        {
            XmlHelper.DeleteXmlNode(Constants.Informer.XSettings, "Setting");
            DefaultSettings();
            foreach (var item in Constants.Informer.Settings)
            {
                try
                {
                    var xKey = item;
                    ...
                    XmlHelper.SaveXmlNode(Constants.Informer.XSettings, "Settings", "Setting", xKey, keyPairList);
                }
                catch (Exception ex)
                {
            ...
            Constants.Informer.XSettings.Save(AppViewModel.Instance.SettingsPath + "Settings.Informer.xml");
        }

        private void DefaultSettings()
        {
            Constants.Informer.Settings.Clear();
        }

        public new void Reset()
        {
            DefaultSettings();
            foreach (var key in Constants.Informer.Settings)
            {
