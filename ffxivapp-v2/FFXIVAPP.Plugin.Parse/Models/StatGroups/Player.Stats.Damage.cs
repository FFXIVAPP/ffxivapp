    ...
    public partial class Player
    {
        ...
        public void SetDamageStat(Line line)
        {
            ...
            if (line.Hit)
            {
                ...
                Stats.GetStat("DTTotal").Value += line.Amount;
                if (line.Crit)
                {
                    ...
                    Stats.GetStat("DTCrit").Value += line.Amount;
                    Stats.GetStat("DTCHit").Value += 1;
                }
                else
                {
                    ...
                    Stats.GetStat("DTReg").Value += line.Amount;
                    Stats.GetStat("DTHit").Value += 1;
                }
            }
