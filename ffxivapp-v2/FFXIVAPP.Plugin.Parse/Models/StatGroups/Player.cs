...
namespace FFXIVAPP.Plugin.Parse.Models.StatGroups
{
    public partial class Player : StatGroup
    {
        ...
        private static IEnumerable<Stat<decimal>> TotalStatList()
        {
            ...
            StatMonitor.TotalOverallDamage.AddDependency(stats["Total"]);
            StatMonitor.RegularDamage.AddDependency(stats["Reg"]);
            StatMonitor.CriticalDamage.AddDependency(stats["Crit"]);
            StatMonitor.TotalOverallHealing.AddDependency(stats["HTotal"]);
            StatMonitor.TotalOverallDamageTaken.AddDependency(stats["DTTotal"]);
            StatMonitor.RegularDamageTaken.AddDependency(stats["DTReg"]);
            StatMonitor.CriticalDamageTaken.AddDependency(stats["DTCrit"]);
            ...
            stats.Add("PerOfDmg", new PercentStat("PerOfDmg", stats["Total"], StatMonitor.RegularDamage));
            stats.Add("PerOfCrit", new PercentStat("PerOfCrit", stats["Crit"], StatMonitor.CriticalDamage));
            stats.Add("PerOfDTDmg", new PercentStat("PerOfDTDmg", stats["DTTotal"], StatMonitor.TotalOverallDamageTaken));
            stats.Add("PerOfDTCDmg", new PercentStat("PerOfDTCDmg", stats["DTCrit"], StatMonitor.CriticalDamageTaken));
            stats.Add("CritPer", new PercentStat("CritPer", stats["CHit"], stats["Hit"]));
            stats.Add("PerOfHeal", new PercentStat("PerOfHeal", stats["HTotal"], StatMonitor.TotalOverallHealing));
