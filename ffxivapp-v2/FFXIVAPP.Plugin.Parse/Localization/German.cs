...
namespace FFXIVAPP.Plugin.Parse.Localization
{
    public abstract class German
    {
        ...
        public static ResourceDictionary Context()
        {
            ...
            Dictionary.Add("parse_MonsterDamageTabHeader", "Monster Damage");
            Dictionary.Add("parse_MonsterHealingTabHeader", "Monster Healing");
            ...
            Dictionary.Add("parse_PlayerDamageByActionText", "Schade door een optreden van Selected Player");
            Dictionary.Add("parse_PlayerDamageToMonstersText", "Schade aan Monsters Door Geselecteerde Player");
            Dictionary.Add("parse_PlayerDamageToMonstersByActionText", "Schade aan Monsters door een optreden van Selected Player");
            Dictionary.Add("parse_PlayerHealingByActionText", "Genezing door een optreden van Selected Player");
            Dictionary.Add("parse_PlayerHealingToPlayersText", "Genezing aan spelers door Selected Player");
            Dictionary.Add("parse_PlayerHealingToPlayersByActionText", "Genezing Om spelers door een optreden van Selected Player");
            Dictionary.Add("parse_PlayerDamageTakenByActionText", "Schade Genomen Uit Monsters door een optreden van Selected Player");
            Dictionary.Add("parse_PlayerDamageTakenByMonstersText", "Schade Genomen Uit Monsters Door Selected Player");
            Dictionary.Add("parse_PlayerDamageTakenByMonstersByActionText", "Schade Genomen Uit Monsters door een optreden van Selected Monster Door Selected Player");
            Dictionary.Add("parse_MonsterDamageByActionText", "Schade door een optreden van Selected Monster");
            Dictionary.Add("parse_MonsterDamageToPlayersText", "Schade aan spelers door Selected Monster");
            Dictionary.Add("parse_MonsterDamageToPlayersByActionText", "Schade aan de spelers door een optreden van Selected Monster");
            Dictionary.Add("parse_MonsterHealingByActionText", "Genezing door een optreden van Selected Monster");
            Dictionary.Add("parse_MonsterHealingToMonstersText", "Genezing Om Monsters Door Selected Monster");
            Dictionary.Add("parse_MonsterHealingToMonstersByActionText", "Genezing Om Monsters door een optreden van Selected Monster");
            Dictionary.Add("parse_MonsterDamageTakenByActionText", "Schade Taken By Actie Door Selected Monster");
            Dictionary.Add("parse_MonsterDamageTakenByPlayersText", "Schade Genomen Uit Spelers door een optreden van Selected Monster");
            Dictionary.Add("parse_MonsterDamageTakenByPlayersByActionText", "Schade Genomen Uit Spelers door een optreden van Selected Player Door Selected Monster");
            Dictionary.Add("parse_MonsterDropsByMonsterText", "Beloningen Door Geselecteerde Monster");
